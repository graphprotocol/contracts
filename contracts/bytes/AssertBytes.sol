...
library AssertBytes {
    ...
    */
    function _equal(bytes memory _a, bytes memory _b)
        internal
        pure
        returns (bool)
    {
    ...
    function equal(bytes memory _a, bytes memory _b, string memory message)
        internal
        returns (bool)
    {
    ...
    function notEqual(bytes memory _a, bytes memory _b, string memory message)
        internal
        returns (bool)
    {
        bool returnBool = _equal(_a, _b);
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function _equalStorage(bytes storage _a, bytes memory _b)
        internal
        view
        returns (bool)
    {
