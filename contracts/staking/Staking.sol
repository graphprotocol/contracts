...
contract Staking is StakingV1Storage, GraphUpgradeable, IStaking {
    ...
    function _withdraw(address _indexer) internal {
        ...
        require(graphToken().transfer(_indexer, tokensToWithdraw), "Cannot transfer tokens");
    ...
    function _withdrawDelegated(
        ...
        if (_delegateToIndexer != address(0)) {
            ...
            require(graphToken().transfer(_delegator, tokensToWithdraw), "Cannot transfer tokens");
        }
