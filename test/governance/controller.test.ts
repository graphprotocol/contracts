...
import { getAccounts, Account, stringToBytes32 } from '../lib/testHelpers'
...
describe('Manager', () => {
  ...
  it('should set contract proxy and test get contract proxy', async function () {
    ...
    // Test the controller
    const id = stringToBytes32('EpochManager')
  ...
  it('should update controller on a manager', async function () {
    const tx = controller
      ...
      .updateController(stringToBytes32('EpochManager'), mockController.address)
