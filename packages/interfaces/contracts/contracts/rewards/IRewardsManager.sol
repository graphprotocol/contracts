...
interface IRewardsManager {
     ...
     * @param newEligibilityReclaimAddress The address to receive eligibility-denied tokens
     */
    function setIndexerEligibilityReclaimAddress(address newEligibilityReclaimAddress) external;
     ...
     * @param newSubgraphReclaimAddress The address to receive subgraph-denied tokens
     */
    function setSubgraphDeniedReclaimAddress(address newSubgraphReclaimAddress) external;
