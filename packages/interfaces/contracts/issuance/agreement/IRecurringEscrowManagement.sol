...
interface IRecurringEscrowManagement {
     ...
     * @dev Requires OPERATOR_ROLE. The effective basis degrades from OnDemand to JustInTime
     ...
     * @dev Requires OPERATOR_ROLE. The effective basis degrades from Full to OnDemand
    ...
    /**
     * @notice Set the minimum thaw fraction to ignore dust thaws.
