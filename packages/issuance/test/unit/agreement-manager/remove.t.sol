...
contract RecurringAgreementManagerRemoveTest is RecurringAgreementManagerSharedTest {
    ...
    function test_Remove_CanceledByServiceProvider() public {
        ...
        emit IRecurringAgreementManager.AgreementRemoved(agreementId, indexer);
    ...
    function test_Remove_Revert_WhenStillClaimable_NotAccepted() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IRecurringAgreementManager.AgreementStillClaimable.selector,
                agreementId,
                storedMaxClaim
            )
        );
