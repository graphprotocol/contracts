...
contract IndexingAgreementManagerMultiIndexerTest is IndexingAgreementManagerSharedTest {
    ...
    function test_MultiIndexer_OfferIsolation() public {
        ...
        assertEq(agreementManager.getIndexerAgreementCount(indexer2), 1);
        assertEq(agreementManager.getIndexerAgreementCount(indexer3), 1);
        ...
        assertEq(
            paymentsEscrow.getBalance(address(agreementManager), address(recurringCollector), indexer3),
            maxClaim3
        );
    }
    ...
    function test_MultiIndexer_MultipleAgreementsPerIndexer() public {
        ...
        assertEq(agreementManager.getIndexerAgreementCount(indexer), 2);
    ...
    function test_MultiIndexer_MaintainOnlyAffectsTargetIndexer() public {
        ...
        // Maintain on indexer2 should revert (still has agreement)
        vm.expectRevert(
    ...
    function test_MultiIndexer_FullLifecycle() public {
        ...
        assertEq(agreementManager.getIndexerAgreementCount(indexer2), 0);

        // 7. Maintain indexer2 (thaw excess escrow)
        agreementManager.maintain(indexer2);
    ...
    function test_MultiIndexer_GetAgreementInfo() public {
        ...
        IIndexingAgreementManager.AgreementInfo memory info1 = agreementManager.getAgreementInfo(id1);
        IIndexingAgreementManager.AgreementInfo memory info2 = agreementManager.getAgreementInfo(id2);

        assertEq(info1.indexer, indexer);
        assertEq(info2.indexer, indexer2);
