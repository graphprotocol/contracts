...
contract ServiceAgreementManagerFuzzTest is ServiceAgreementManagerSharedTest {
    ...
    function testFuzz_Offer_EscrowFundedUpToAvailable(
        ...
        uint256 escrowBalance = paymentsEscrow
            .getEscrowAccount(address(agreementManager), address(recurringCollector), indexer)
            .balance;
