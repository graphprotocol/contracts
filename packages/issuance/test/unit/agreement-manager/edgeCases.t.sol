...
/// @notice Edge case and boundary condition tests for ServiceAgreementManager.
contract ServiceAgreementManagerEdgeCasesTest is ServiceAgreementManagerSharedTest {
    ...
    function test_CancelAgreement_Revert_WhenDataServiceHasNoCode() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IServiceAgreementManager.InvalidDataService.selector, eoa));
        vm.prank(operator);
    ...
    function test_GetAgreementInfo_IncludesHashes() public {
        ...
        IServiceAgreementManager.AgreementInfo memory info = agreementManager.getAgreementInfo(agreementId);
    ...
    function test_ReofferAfterRemove_FullLifecycle() public {
        ...
        IServiceAgreementManager.AgreementInfo memory info = agreementManager.getAgreementInfo(reofferedId);
    ...
    function test_Offer_Revert_ZeroServiceProvider() public {
        ...
        token.mint(address(agreementManager), 1_000_000 ether);
        vm.expectRevert(IServiceAgreementManager.ServiceProviderZeroAddress.selector);
        vm.prank(operator);
    ...
    function test_Offer_Revert_ZeroDataService() public {
        ...
        token.mint(address(agreementManager), 1_000_000 ether);
        vm.expectRevert(IServiceAgreementManager.DataServiceZeroAddress.selector);
        vm.prank(operator);
        agreementManager.offerAgreement(rca);
    }
