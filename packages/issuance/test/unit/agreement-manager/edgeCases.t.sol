...
contract RecurringAgreementManagerEdgeCasesTest is RecurringAgreementManagerSharedTest {
    ...
    function test_CancelAgreement_Revert_WhenDataServiceHasNoCode() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(IRecurringAgreementManager.InvalidDataService.selector, eoa));
        vm.prank(operator);
    ...
    function test_RevokeOffer_CleansUpAgreementHash() public {
        ...
        // Hash is authorized
        assertEq(agreementManager.approveAgreement(rcaHash), IContractApprover.approveAgreement.selector);
    ...
    function test_RevokeOffer_CleansUpPendingUpdateHash() public {
        ...
        assertEq(agreementManager.approveAgreement(updateHash), IContractApprover.approveAgreement.selector);
    ...
    function test_OfferUpdate_CleansUpReplacedPendingHash() public {
        ...
        assertEq(agreementManager.approveAgreement(hash2), IContractApprover.approveAgreement.selector);
    }
    ...
    function test_GetAgreementInfo_IncludesHashes() public {
        ...
        IRecurringAgreementManager.AgreementInfo memory info = agreementManager.getAgreementInfo(agreementId);
    ...
    function test_Offer_ZeroOngoingTokensPerSecond() public {
        ...
        assertEq(agreementManager.getRequiredEscrow(address(recurringCollector), indexer), 100 ether);
    }
    ...
    function test_Remove_AtExactDeadline_NotAccepted() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IRecurringAgreementManager.AgreementStillClaimable.selector, agreementId, maxClaim)
        );
        agreementManager.removeAgreement(agreementId);
    }
    ...
    function test_UpdateEscrow_FullThawWithdrawCycle() public {
        ...
        // First updateEscrow: initiates thaw
        agreementManager.updateEscrow(address(recurringCollector), indexer);

        // Warp past mock's thawing period (1 day)
        vm.warp(block.timestamp + 1 days + 1);

        // Second updateEscrow: withdraws thawed tokens, then no more to thaw
        agreementManager.updateEscrow(address(recurringCollector), indexer);

        // Third updateEscrow: should be a no-op (nothing to thaw or withdraw)
        agreementManager.updateEscrow(address(recurringCollector), indexer);
    }
    ...
    function test_OfferUpdate_ZeroValuePendingUpdate_HashCleanedOnReplace() public {
        ...
        assertEq(agreementManager.approveAgreement(zeroHash), IContractApprover.approveAgreement.selector);
        ...
        assertEq(agreementManager.approveAgreement(newHash), IContractApprover.approveAgreement.selector);
    ...
    function test_ReofferAfterRemove_FullLifecycle() public {
        ...
        IRecurringAgreementManager.AgreementInfo memory info = agreementManager.getAgreementInfo(reofferedId);
    ...
    function test_Offer_Revert_ZeroServiceProvider() public {
        ...
        token.mint(address(agreementManager), 1_000_000 ether);
        vm.expectRevert(IRecurringAgreementManager.ServiceProviderZeroAddress.selector);
        vm.prank(operator);
    ...
    function test_Offer_Revert_ZeroDataService() public {
        ...
        token.mint(address(agreementManager), 1_000_000 ether);
        vm.expectRevert(IRecurringAgreementManager.DataServiceZeroAddress.selector);
        vm.prank(operator);
        agreementManager.offerAgreement(rca, address(recurringCollector));
    }
    ...
    function test_CancelAgreement_EmitsEvent_WhenAccepted() public {
        ...
        emit IRecurringAgreementManager.AgreementCanceled(agreementId, indexer);
    ...
    function test_OfferUpdate_ThreeConsecutiveReplacements() public {
        ...
        assertEq(agreementManager.getRequiredEscrow(address(recurringCollector), indexer), originalMaxClaim + pending1);
        ...
        assertEq(agreementManager.getRequiredEscrow(address(recurringCollector), indexer), originalMaxClaim + pending2);
        ...
        assertEq(agreementManager.getRequiredEscrow(address(recurringCollector), indexer), originalMaxClaim + pending3);
        ...
        assertEq(agreementManager.approveAgreement(hash3), IContractApprover.approveAgreement.selector);
    }
