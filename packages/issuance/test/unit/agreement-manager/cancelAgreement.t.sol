...
contract IndexingAgreementManagerCancelAgreementTest is IndexingAgreementManagerSharedTest {
    ...
    function test_CancelAgreement_Revert_WhenNotAccepted() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IIndexingAgreementManager.IndexingAgreementManagerAgreementNotAccepted.selector,
                agreementId
            )
        );
        vm.prank(operator);
