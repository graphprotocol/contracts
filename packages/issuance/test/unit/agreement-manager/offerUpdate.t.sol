...
contract IndexingAgreementManagerOfferUpdateTest is IndexingAgreementManagerSharedTest {
    ...
    function test_OfferUpdate_AuthorizesHash() public {
        ...
        bytes4 result = agreementManager.isAuthorizedAgreement(updateHash);
    ...
    function test_OfferUpdate_FundsEscrow() public {
        ...
        assertEq(escrowBalance, totalRequired);
    }
    ...
    function test_OfferUpdate_EmitsEvent() public {
        ...
        emit IIndexingAgreementManager.AgreementUpdateOffered(agreementId, pendingMaxClaim, 1);
