...
contract IndexingAgreementManagerOfferTest is IndexingAgreementManagerSharedTest {
    ...
    function test_Offer_PartialFunding_WhenInsufficientBalance() public {
        ...
        assertEq(escrowBalance, available);
    ...
    function test_Offer_EmitsEvent() public {
        ...
        emit IIndexingAgreementManager.AgreementOffered(expectedId, indexer, expectedMaxClaim);
    ...
    function test_Offer_AuthorizesHash() public {
        ...
        assertEq(result, agreementManager.isAuthorizedAgreement.selector);
    }
    ...
    function test_Offer_Revert_WhenPayerMismatch() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IIndexingAgreementManager.IndexingAgreementManagerPayerMismatch.selector,
                address(0xdead),
                address(agreementManager)
            )
        );
    ...
    function test_Offer_Revert_WhenAlreadyOffered() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IIndexingAgreementManager.IndexingAgreementManagerAgreementAlreadyOffered.selector,
                agreementId
            )
        );
        vm.prank(operator);
