...
contract RecurringAgreementManagerApproverTest is RecurringAgreementManagerSharedTest {
    ...
    function test_SupportsInterface_IRecurringAgreementManager() public view {
        assertTrue(agreementManager.supportsInterface(type(IRecurringAgreementManager).interfaceId));
    }
