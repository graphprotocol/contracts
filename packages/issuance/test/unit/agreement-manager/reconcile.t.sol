...
contract ServiceAgreementManagerReconcileTest is ServiceAgreementManagerSharedTest {
    ...
    function test_ReconcileAgreement_EmitsEvent() public {
        ...
        emit IServiceAgreementManager.AgreementReconciled(agreementId, 3700 ether, 0);
