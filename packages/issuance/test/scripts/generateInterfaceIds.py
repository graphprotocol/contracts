...
def extract_interface_ids():
    ...
    script_dir = Path(__file__).parent
    extractor_path = script_dir.parent.parent / "artifacts" / "contracts" / "test" / "InterfaceIdExtractor.sol" / "InterfaceIdExtractor.json"
...
"""
    ...
    script_dir = Path(__file__).parent
    output_file = script_dir.parent / "tests" / "helpers" / "interfaceIds.ts"
