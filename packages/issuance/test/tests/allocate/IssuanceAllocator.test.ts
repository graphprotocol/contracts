...
describe('IssuanceAllocator', () => {
  ...
  describe('Target Management', () => {
    ...
    it('should validate setTargetAllocation parameters and constraints', async () => {
      ...
      // Test 1: Should revert when setting allocation for the default target (address zero)
      // With the default allocation model, address(0) is the default allocation target
