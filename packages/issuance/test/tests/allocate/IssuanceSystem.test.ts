...
import { setupOptimizedAllocateSystem } from './optimizedFixtures'
import { expectRatioToEqual, mineBlocks, TestConstants } from './testPatterns'
...
describe('Issuance System', () => {
  ...
  before(async () => {
    ...
    system = await setupOptimizedAllocateSystem({
