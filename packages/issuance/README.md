...
- **[ServiceAgreementManager](contracts/agreement/ServiceAgreementManager.md)** - Funds PaymentsEscrow deposits for RCAs using issuance tokens, tracking max-next-claim per agreement per indexer
