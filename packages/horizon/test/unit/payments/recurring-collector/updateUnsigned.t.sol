...
contract RecurringCollectorUpdateUnsignedTest is RecurringCollectorSharedTest {
    ...
    function _acceptUnsigned(
        ...
        return _recurringCollector.acceptUnsigned(rca);
    }
    ...
    function test_UpdateUnsigned() public {
        ...
        vm.prank(rca.dataService);
        _recurringCollector.updateUnsigned(rcau);
    ...
    function test_UpdateUnsigned_Revert_WhenPayerNotContract() public {
        ...
        IRecurringCollector.SignedRCA memory signedRCA = _recurringCollectorHelper.generateSignedRCA(rca, signerKey);
        _setupValidProvision(rca.serviceProvider, rca.dataService);
        vm.prank(rca.dataService);
        bytes16 agreementId = _recurringCollector.accept(signedRCA);
    ...
    function test_UpdateUnsigned_Revert_WhenHashNotAuthorized() public {
        ...
        // Don't authorize the update hash
        vm.expectRevert("MockContractApprover: not authorized");
        vm.prank(rca.dataService);
        _recurringCollector.updateUnsigned(rcau);
    }
