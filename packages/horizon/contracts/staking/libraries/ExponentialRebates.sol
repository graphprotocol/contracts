...
library ExponentialRebates {
    ...
    /**
     * @notice The exponential formula used to compute fee-based rewards for staking pools in a given epoch
     * @dev This function does not perform bounds checking on the inputs, but the following conditions
     * need to be true:
