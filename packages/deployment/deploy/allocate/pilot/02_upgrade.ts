...
// PilotAllocation Upgrade
//
// Upgrades PilotAllocation proxy to DirectAllocation implementation via per-proxy ProxyAdmin.
...
//
// Usage:
//   FORK_NETWORK=arbitrumSepolia npx hardhat deploy --tags pilot-allocation-upgrade --network localhost
...
func.tags = Tags.pilotAllocationUpgrade
func.dependencies = [
