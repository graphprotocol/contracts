...
interface IStakingBase is IStakingData {
     ...
     * @return tokens Amount of tokens allocated
     * @return createdAtEpoch Epoch when allocation was created
     * @return closedAtEpoch Epoch when allocation was closed (0 if still active)
     */
