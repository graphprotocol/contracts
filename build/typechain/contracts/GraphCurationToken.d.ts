...
interface GraphCurationTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class GraphCurationToken extends Contract {
  ...
  interface: GraphCurationTokenInterface;
