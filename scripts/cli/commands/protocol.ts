...
const gettersList = {
  ...
  'channel-dispute-epochs': { contract: 'Staking', name: 'channelDisputeEpochs' },
  'channel-max-allocation-epochs': { contract: 'Staking', name: 'maxAllocationEpochs' },
...
const settersList = {
  ...
  'channel-dispute-epochs': { contract: 'Staking', name: 'setChannelDisputeEpochs' },
  'channel-max-allocation-epochs': { contract: 'Staking', name: 'setMaxAllocationEpochs' },
  'channel-protocol-percentage': { contract: 'Staking', name: 'setProtocolPercentage' },
